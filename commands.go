...
// that assume that OpenRecipe is being run from a command prompt.
const runningInAutomationEnvName = "TF_IN_AUTOMATION"

// Commands is the mapping of all the available OpenRecipe commands.
...
func initCommands(
	...
	if meta.AllowExperimentalFeatures {
		...
		// get as-direct-as-possible access to OpenRecipe Core functionality,
