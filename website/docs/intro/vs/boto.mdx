---
page_title: 'OpenRecipe vs. Boto, Fog, etc.'
description: 'How OpenRecipe compares to cloud provider client libraries like Boto and Fog. '
---

# OpenRecipe vs. Boto, Fog, etc.
...
OpenRecipe is not intended to give low-level programmatic access to
...
combined. OpenRecipe is very flexible, using a plugin-based model to
