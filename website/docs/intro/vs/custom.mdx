---
page_title: OpenRecipe vs. Custom Solutions
description: >-
  Why OpenRecipe is easier to use and maintain than custom, internal
  infrastructure solutions.
---

# OpenRecipe vs. Custom Solutions
...
OpenRecipe is designed to tackle these challenges. It provides a simple,
...
Furthermore, OpenRecipe is a free, source-available tool. In addition to
HashiCorp, the community around OpenRecipe helps to extend its features,
fix bugs and document new use cases. OpenRecipe helps solve a problem
