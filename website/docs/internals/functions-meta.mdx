...
description: >-
  ...
  functions available in the current OpenRecipe version.
---

# Functions Metadata

The `terraform metadata functions` command is used to print signatures for the functions available in the current OpenRecipe version.

-> `terraform metadata functions` requires **OpenRecipe v1.4 or later**.
...
The output includes a `format_version` key, which as of OpenRecipe 1.4.0 has
