...
description: >-
  OpenRecipe builds a dependency graph from the OpenRecipe configurations, and
...
from the OpenRecipe configurations, and walks this graph to
...
of OpenRecipe. You don't need to understand these details to
effectively use OpenRecipe. The details are documented here for
those who wish to learn about them without having to go
spelunking through the source code.

For some background on graph theory, and a summary of how
OpenRecipe applies it, see the HashiCorp 2016 presentation
...
OpenRecipe. By default, up to 10 nodes in the graph will be processed
...
necessary for normal usage of OpenRecipe. It may be helpful in certain special
use cases or to help debug OpenRecipe issues.
...
clients. For this reason, OpenRecipe does not use this `parallelism` feature to
