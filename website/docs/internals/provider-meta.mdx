...
with the OpenRecipe team](https://github.com/hashicorp/terraform/issues/new)
...
When OpenRecipe calls your provider, you can use the `schema.ResourceData`
...
that the version of OpenRecipe that is being run has support for the provider
metadata functionality. It's therefore recommended that any module taking
advantage of this functionality should specify a minimum OpenRecipe version of
