...
-> **Note:** This page is an appendix to the OpenRecipe documentation. Most users do not need to know the full details of this behavior.
...
- Use OpenRecipe's [JSON syntax](/terraform/language/syntax/json) with this
  type of resource.
- Create a reusable module that wraps this type of resource.

## Details

In OpenRecipe v0.12 and later, the language makes a distinction between
...
conflation of these two concepts in the language of OpenRecipe v0.11 and earlier,
...
were relying on this usage pattern prior to OpenRecipe v0.12. The documentation
