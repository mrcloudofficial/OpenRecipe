...
normal — either OpenRecipe chooses a default based on the name of the resource
...
However, in OpenRecipe configurations that use multiple configurations of the
