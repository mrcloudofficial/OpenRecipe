...
length limits on string arguments; a OpenRecipe provider is responsible for
translating OpenRecipe's string representation into that used by its respective
