...
| `!!null`      | The OpenRecipe language `null` value                                |
...
The OpenRecipe language automatic type conversion rules mean that you don't
...
OpenRecipe language's type system cannot represent. Therefore this YAML decoder
