...
the PKCS #1 v1.5 padding scheme. OpenRecipe uses the "standard" Base64 alphabet
...
OpenRecipe has no corresponding function for _encrypting_ a message. Use this
