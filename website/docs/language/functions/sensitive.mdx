...
`sensitive` takes any value and returns a copy of it marked so that OpenRecipe
...
OpenRecipe automatically considering them as sensitive.
...
because they may be exposed in other ways outside of OpenRecipe's control.
