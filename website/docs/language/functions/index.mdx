...
The OpenRecipe language includes a number of built-in functions that you can
...
The OpenRecipe language does not support user-defined functions, and so only
...
You can experiment with the behavior of OpenRecipe's built-in functions from
