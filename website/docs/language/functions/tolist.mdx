...
Explicit type conversions are rarely necessary in OpenRecipe because it will
...
consistent within a particular run of OpenRecipe.
...
Since OpenRecipe's concept of a list requires all of the elements to be of the
