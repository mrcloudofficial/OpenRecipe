...
A OpenRecipe module (usually the root module of a configuration) can _call_ other
...
In addition to modules from the local filesystem, OpenRecipe can load modules
...
The [OpenRecipe Registry](https://registry.terraform.io/browse/modules) hosts a
broad collection of publicly available OpenRecipe modules for configuring many
kinds of common infrastructure. These modules are free to use, and OpenRecipe can
...
for your own infrastructure needs. [OpenRecipe Cloud](https://cloud.hashicorp.com/products/terraform) and
[OpenRecipe Enterprise](/terraform/enterprise) both include a private
