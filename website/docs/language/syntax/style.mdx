...
description: >-
  Learn recommended formatting conventions for the OpenRecipe language and a
  command to automatically enforce them.
---

# Style Conventions

The OpenRecipe parser allows you some flexibility in how you lay out the
elements in your configuration files, but the OpenRecipe language also has some
...
* For blocks that contain both arguments and "meta-arguments" (as defined by
  the OpenRecipe language semantics), list meta-arguments first
