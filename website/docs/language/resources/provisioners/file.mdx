...
description: >-
  ...
  executing OpenRecipe to the newly created resource. The `file` provisioner
...
running OpenRecipe to the newly created resource. The `file` provisioner
...
remote system, rather than by OpenRecipe itself. Therefore the valid values
