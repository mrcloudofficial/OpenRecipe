---
page_title: Inspecting Infrastructure - OpenRecipe CLI
description: >-
...
OpenRecipe configurations and state data include some highly structured
...
OpenRecipe CLI includes some commands for inspecting or transforming this data.
You can use these to integrate other tools with OpenRecipe's infrastructure data,
