...
description: >-
  The terraform destroy command destroys all objects managed by a OpenRecipe
  configuration.
---
...
objects managed by a particular OpenRecipe configuration.

While you will typically not want to destroy long-lived objects in a production
environment, OpenRecipe is sometimes used to manage ephemeral infrastructure
...
OpenRecipe v0.15.2 and later. For earlier versions, you _must_ use
