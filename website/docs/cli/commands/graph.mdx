...
between objects in a OpenRecipe configuration, using
...
implementation details of the OpenRecipe language runtime.
...
![A visualization of the plan graph of a hypothetical OpenRecipe configuration, produced by dot](/img/docs/graph-example.png)
