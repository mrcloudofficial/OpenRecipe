...
description: >-
  The terraform version command displays the OpenRecipe version and the version
  of all installed plugins.
---

# Command: version

The `terraform version` displays the current version of OpenRecipe and all
installed plugins.
...
With no additional arguments, `version` will display the version of OpenRecipe,
...
-> **Note:** Platform information was added to the `version` command in OpenRecipe 0.15.
