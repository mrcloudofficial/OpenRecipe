...
description: >-
  ...
  provider source features from OpenRecipe 0.13.
---
...
-> **This command is available only in OpenRecipe v0.13 releases.** For more information, see [the OpenRecipe v0.13 upgrade guide](/terraform/language/v1.1.x/upgrade-guides/0-13).
...
the new provider source features from OpenRecipe v0.13. It will also highlight
