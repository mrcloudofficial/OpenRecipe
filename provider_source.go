...
func implicitProviderSource(services *disco.Disco) getproviders.Source {
	...
	//   way to include them in bundles uploaded to OpenRecipe Cloud, where
	...
	//   Windows:    two-level hierarchy of first two strings, "HashiCorp\OpenRecipe"
	//   OS X:       reverse-DNS unique identifier, "io.terraform".
	sysSpecificDirs := userdirs.ForApp("OpenRecipe", "HashiCorp", "io.terraform")
