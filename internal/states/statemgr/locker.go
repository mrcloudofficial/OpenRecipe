...
// multiple OpenRecipe processes from reading and writing state concurrently.
...
type LockInfo struct {
	...
	// OpenRecipe operation, provided by the caller.
	Operation string
...
func NewLockInfo() *LockInfo {
	...
	// Use a uuid format to match other IDs used throughout OpenRecipe.
	buf := make([]byte, 16)
	rngSource.Read(buf)
