...
// Changes describes various actions that OpenRecipe will attempt to take if
...
type ResourceInstanceChange struct {
	...
	// OpenRecipe that relates to this change. OpenRecipe will save this
...
// a normal apply or a destroy. This flag deals with the fact that OpenRecipe
