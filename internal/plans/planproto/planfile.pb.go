...
type Plan struct {
	...
	//
	// This is saved only for UI purposes, so that OpenRecipe can tailor its
	// rendering of the plan depending on the mode. This must never be used to
	// make decisions in OpenRecipe Core during the applying of a plan.
	...
	// OpenRecipe, computed by comparing the previous run's state to the state
	// after refresh.
	...
	// The version string for the OpenRecipe binary that created this plan.
...
type ResourceInstanceChange struct {
	...
	// OpenRecipe having reacted to refactoring annotations in the configuration.
...
var file_planfile_proto_rawDesc = []byte{
	...
	0x56, 0x45, 0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x10, 0x0c, 0x42, 0x39, 0x5a, 0x37, 0x67,
