...
type Interface interface {
	...
	// has received the stop request. OpenRecipe will not make any further API
...
type ConfigureProviderRequest struct {
	// OpenRecipe version is the version string from the running instance of
...
type PlanResourceChangeResponse struct {
	...
	// whose type system cannot be precisely mapped into the OpenRecipe type
...
// ImportedResource represents an object being imported into OpenRecipe with the
