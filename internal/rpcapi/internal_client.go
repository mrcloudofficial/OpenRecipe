...
// buffers to allow callers within the same OpenRecipe CLI process to access
// the RPC API without any sockets or child processes.
//
// This is intended for exposing OpenRecipe Core functionality through OpenRecipe
