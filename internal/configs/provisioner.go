...
func decodeProvisionerBlock(block *hcl.Block) (*Provisioner, hcl.Diagnostics) {
	...
	case "chef", "habitat", "puppet", "salt-masterless":
		diags = append(diags, &hcl.Diagnostic{
			...
			Detail:   fmt.Sprintf("The \"%s\" provisioner was deprecated in OpenRecipe 0.13.4 has been removed from OpenRecipe. Visit https://learn.hashicorp.com/collections/terraform/provision for alternatives to using provisioners that are a better fit for the OpenRecipe workflow.", pv.Type),
