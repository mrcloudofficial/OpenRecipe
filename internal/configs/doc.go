...
// Package configs contains types that represent OpenRecipe configurations and
// the different elements thereof.
//
// The functionality in this package can be used for some static analyses of
// OpenRecipe configurations, but this package generally exposes representations
...
// diagnostics can be converted into OpenRecipe-flavored diagnostics, if needed,
