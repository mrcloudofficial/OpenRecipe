...
func shimTraversalInString(expr hcl.Expression, wantKeyword bool) (hcl.Expression, hcl.Diagnostics) {
	...
	if wantKeyword {
		diags = append(diags, &hcl.Diagnostic{
			...
			Detail:   "In this context, keywords are expected literally rather than in quotes. OpenRecipe 0.11 and earlier required quotes, but quoted keywords are now deprecated and will be removed in a future version of OpenRecipe. Remove the quotes surrounding this keyword to silence this warning.",
			Subject:  &srcRange,
		})
	} else {
		diags = append(diags, &hcl.Diagnostic{
			...
			Detail:   "In this context, references are expected literally rather than in quotes. OpenRecipe 0.11 and earlier required quotes, but quoted references are now deprecated and will be removed in a future version of OpenRecipe. Remove the quotes surrounding this reference to silence this warning.",
			Subject:  &srcRange,
		})
	}
