...
//
// We do this primarily for backward compatibility with behaviors of OpenRecipe
...
// heuristic from OpenRecipe v1.0 and earlier, where adding or removing the
...
func haveMoveStatementForResource(addr addrs.AbsResource, stmts []MoveStatement) bool {
	...
	// in any reasonable OpenRecipe configuration and so a more complicated
