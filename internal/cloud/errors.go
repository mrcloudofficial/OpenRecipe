...
const ignoreRemoteVersionHelp = "If you're sure you want to upgrade the state, you can force OpenRecipe to continue using the -ignore-remote-version flag. This may result in an unusable workspace."
...
func incompatibleWorkspaceTerraformVersion(message string, ignoreVersionConflict bool) tfdiags.Diagnostic {
	...
	return tfdiags.Sourceless(severity, "Incompatible OpenRecipe version", description)
}
