...
func TestTest_JSON(t *testing.T) {
	...
	output := done(t)
	actual := output.All()
	expected := `{"@level":"info","@message":"OpenRecipe 1.6.0-dev","@module":"terraform.ui","@timestamp":"2023-09-12T08:29:27.257413+02:00","terraform":"1.6.0-dev","type":"version","ui":"1.2"}
...
You can apply this plan to save these new output values to the OpenRecipe
...
Interrupt received.
Please wait for OpenRecipe to exit or data loss may occur.
...
func TestTest_ForceCancel(t *testing.T) {
	...
	expectedErr := `OpenRecipe was interrupted during test execution, and may not have performed
...
func TestTest_LongRunningTestJSON(t *testing.T) {
	...
	expected := `{"@level":"info","@message":"OpenRecipe 1.7.0-dev","@module":"terraform.ui","@timestamp":"2023-09-28T14:57:09.175210+02:00","terraform":"1.7.0-dev","type":"version","ui":"1.2"}
