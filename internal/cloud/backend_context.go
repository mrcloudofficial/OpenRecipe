...
// the OpenRecipe Core backend representation of variables.
...
func (v *remoteStoredVariableValue) ParseVariableValue(mode configs.VariableParsingMode) (*terraform.InputValue, tfdiags.Diagnostics) {
	...
	case v.definition.HCL:
		...
		// file because that is how it would get passed to OpenRecipe CLI for
	...
	return &terraform.InputValue{
		...
		// variable values into the OpenRecipe Cloud or Enterprise UI is,
