					...
					commands: []tfCommand{
						{
							...
							expectedCmdOutput: `Migrating from backend "remote" to OpenRecipe Cloud.`,
							userInput:         []string{"yes", "yes"},
							postInputOutput: []string{
								`Should OpenRecipe migrate your existing state?`,
								`OpenRecipe Cloud has been successfully initialized!`},
						},
						{
					...
					commands: []tfCommand{
						{
							...
							postInputOutput: []string{
								`Should OpenRecipe migrate your existing state?`,
								`OpenRecipe Cloud requires all workspaces to be given an explicit name.`,
								`OpenRecipe Cloud has been successfully initialized!`},
						},
						{
							command:           []string{"workspace", "show"},
			...
			operations: []operationSets{
				{
					...
					commands: []tfCommand{
						{
							command:           []string{"init"},
							expectedCmdOutput: `OpenRecipe has been successfully initialized!`,
						},
						{
							command:         []string{"apply", "-auto-approve"},
							postInputOutput: []string{`Apply complete!`},
					...
					commands: []tfCommand{
						{
							...
							userInput:         []string{"1"},
							postInputOutput:   []string{`OpenRecipe has been successfully initialized!`},
						},
						{
							command:         []string{"apply", "-auto-approve"},
							postInputOutput: []string{`Apply complete!`},
					...
					commands: []tfCommand{
						{
							...
							userInput:         []string{"yes"},
							postInputOutput:   []string{`OpenRecipe Cloud has been successfully initialized!`},
						},
						{
							command:           []string{"workspace", "show"},
