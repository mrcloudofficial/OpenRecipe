	...
	s := &schema.Backend{
		Schema: map[string]*schema.Schema{
			...
			"skip_schema_creation": {
				...
				Optional:    true,
				Description: "If set to `true`, OpenRecipe won't try to create the Postgres schema",
			...
			"skip_table_creation": {
				Type:        schema.TypeBool,
				Optional:    true,
				Description: "If set to `true`, OpenRecipe won't try to create the Postgres table",
			...
			"skip_index_creation": {
				Type:        schema.TypeBool,
				Optional:    true,
				Description: "If set to `true`, OpenRecipe won't try to create the Postgres index",
