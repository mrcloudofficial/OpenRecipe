...
// because backends are currently hardcoded into OpenRecipe and can't be
...
//
// Backends are hardcoded into OpenRecipe because the API for backends uses
...
func Init(services *disco.Disco) {
	...
	RemovedBackends = map[string]string{
		"artifactory": `The "artifactory" backend is not supported in OpenRecipe v1.3 or later.`,
		"azure":       `The "azure" backend name has been removed, please use "azurerm".`,
		"etcd":        `The "etcd" backend is not supported in OpenRecipe v1.3 or later.`,
		"etcdv3":      `The "etcdv3" backend is not supported in OpenRecipe v1.3 or later.`,
		"manta":       `The "manta" backend is not supported in OpenRecipe v1.3 or later.`,
		"swift":       `The "swift" backend is not supported in OpenRecipe v1.3 or later.`,
	}
}
...
// this only before OpenRecipe is executing to prevent odd behavior of backends
