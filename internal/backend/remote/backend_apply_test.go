...
import (
	...
	"github.com/mrcloud/openrecipe/internal/addrs"
	"github.com/mrcloud/openrecipe/internal/backend"
	"github.com/mrcloud/openrecipe/internal/cloud"
	"github.com/mrcloud/openrecipe/internal/command/arguments"
	"github.com/mrcloud/openrecipe/internal/command/clistate"
	"github.com/mrcloud/openrecipe/internal/command/views"
	"github.com/mrcloud/openrecipe/internal/depsfile"
	"github.com/mrcloud/openrecipe/internal/initwd"
	"github.com/mrcloud/openrecipe/internal/plans"
	"github.com/mrcloud/openrecipe/internal/plans/planfile"
	"github.com/mrcloud/openrecipe/internal/states/statemgr"
	"github.com/mrcloud/openrecipe/internal/terminal"
	"github.com/mrcloud/openrecipe/internal/recipe"
	tfversion "github.com/mrcloud/openrecipe/version"
)
...
func TestRemote_applyVersionCheck(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			// SETUP: set the operations and OpenRecipe Version fields on the
			// remote workspace
