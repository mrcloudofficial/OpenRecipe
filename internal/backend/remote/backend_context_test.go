...
import (
	...
	"github.com/mrcloud/openrecipe/internal/tfdiags"
	...
	"github.com/mrcloud/openrecipe/internal/configs"
...
func TestRemoteStoredVariableValue(t *testing.T) {
	tests := map[string]struct {
		...
		"HCL computation": {
			...
			// operations in OpenRecipe 0.12 (due to OpenRecipe Cloud/Enterprise
