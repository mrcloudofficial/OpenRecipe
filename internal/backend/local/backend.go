...
// locally. This is the "default" backend and implements normal OpenRecipe
...
type Local struct {
	...
	// OpenRecipe context. Many of these will be overridden or merged by
	...
	default:
		return nil, fmt.Errorf(
			"unsupported operation type: %s\n\n"+
				"This is a bug in OpenRecipe and should be reported. The local backend\n"+
				"is built-in to OpenRecipe and should always support all operations.",
			op.Type)
	}
...
OpenRecipe encountered an error attempting to save the state before cancelling the current operation. Once the operation is complete another attempt will be made to save the final state.`
