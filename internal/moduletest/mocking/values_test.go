...
func TestComputedValuesForDataSource(t *testing.T) {
	tcs := map[string]struct {
		...
		"invalid_replacement_path_nested": {
			...
			expectedFailures: []string{
				"OpenRecipe expected an object type for attribute \"nested_object\" defined within the mocked data at :0,0-0, but found string.",
			},
		},
		...
		"invalid_replacement_type": {
			...
			expectedFailures: []string{
				"OpenRecipe could not compute a value for the target type string with the mocked data defined at :0,0-0 with the attribute \"id\": string required.",
			},
		},
		"invalid_replacement_type_nested": {
			...
			expectedFailures: []string{
				"OpenRecipe could not compute a value for the target type string with the mocked data defined at :0,0-0 with the attribute \"nested.id\": string required.",
			},
		},
		"invalid_replacement_type_nested_block": {
			...
			expectedFailures: []string{
				"OpenRecipe could not compute a value for the target type string with the mocked data defined at :0,0-0 with the attribute \"block.id\": string required.",
			},
		},
	}
