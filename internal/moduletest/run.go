...
//
// Point 2 is a bit complicated so worth expanding on. In normal OpenRecipe
...
// identified to the user but not to fail the actual OpenRecipe operation. During
...
// diagnostics were generated by custom conditions. OpenRecipe adds the
