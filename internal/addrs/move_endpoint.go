...
// OpenRecipe hints about historical configuration changes that might
// prompt creating a different plan than OpenRecipe would by default.
//
...
type MoveEndpoint struct {
	...
	// relative address, even though everywhere else in OpenRecipe
