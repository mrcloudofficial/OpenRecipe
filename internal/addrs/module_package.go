...
// A ModulePackage represents a physical location where OpenRecipe can retrieve
// a module package, which is an archive, repository, or other similar
// container which delivers the source code for one or more OpenRecipe modules.
//
