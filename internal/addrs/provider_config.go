...
// provider address in the legacy form used by OpenRecipe v0.12 and earlier.
...
// OpenRecipe v0.13. Later versions of OpenRecipe reject state snapshots using
// this format, and so users must follow the OpenRecipe v0.13 upgrade guide
// in that case.
//
