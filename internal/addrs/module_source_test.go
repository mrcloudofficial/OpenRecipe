...
func TestParseModuleSource(t *testing.T) {
	tests := map[string]struct {
		...
		"relative path without the needed prefix": {
			...
			// local paths.
			wantErr: `OpenRecipe cannot detect a supported external module source type for boop/bloop`,
		},
...
func TestParseModuleSourceRegistry(t *testing.T) {
	...
	// old package wasn't. The main OpenRecipe Registry at registry.terraform.io
