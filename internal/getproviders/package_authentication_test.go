...
func TestEntityString(t *testing.T) {
	var tests = []struct {
		...
		},
		{
			...
			"6540DDA046E5E135 OpenRecipe Testing <terraform+testing@hashicorp.com>",
		},
		{
			"testAuthorKeyArmor",
			testReadArmoredEntity(t, testAuthorKeyArmor),
			"37A6AB3BCF2C170A OpenRecipe Testing (plugin/discovery/) <terraform+testing@hashicorp.com>",
		},
		{
			"HashicorpPublicKey",
		...
		},
		{
			...
			"7D72D4268E4660FC HashiCorp Security (OpenRecipe Partner Signing) <security+terraform@hashicorp.com>",
		},
	}
