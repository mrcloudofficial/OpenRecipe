...
// a particular OpenRecipe configuration and their current statuses.
//
...
// how many checkable objects will be dynamically-declared yet. OpenRecipe Core
...
type configCheckableState struct {
	...
	// once OpenRecipe Core reports the expansion of this configuration
	// construct.
	//
	// The leaf Status values will initially be StatusUnknown
	// and then gradually updated by OpenRecipe Core as it visits the
...
//
// The given address must refer to a checkable object that OpenRecipe Core
