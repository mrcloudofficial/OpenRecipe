...
const (
	...
	// StatusPass represents that OpenRecipe Core has evaluated the check's
	// condition and it returned true, indicating success.
	StatusPass Status = 'P'

	// StatusFail represents that OpenRecipe Core has evaluated the check's
	// condition and it returned false, indicating failure.
	StatusFail Status = 'F'

	// StatusError represents that OpenRecipe Core tried to evaluate the check's
