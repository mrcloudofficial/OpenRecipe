...
//
// This function is deprecated in OpenRecipe v0.12
var ListFunc = function.New(&function.Spec{
	...
	Type: func(args []cty.Value) (ret cty.Type, err error) {
		return cty.DynamicPseudoType, fmt.Errorf("the \"list\" function was deprecated in OpenRecipe v0.12 and is no longer available; use tolist([ ... ]) syntax to write a literal list")
	},
	Impl: func(args []cty.Value, retType cty.Type) (ret cty.Value, err error) {
		return cty.DynamicVal, fmt.Errorf("the \"list\" function was deprecated in OpenRecipe v0.12 and is no longer available; use tolist([ ... ]) syntax to write a literal list")
	},
})
...
var MapFunc = function.New(&function.Spec{
	...
	Type: func(args []cty.Value) (ret cty.Type, err error) {
		return cty.DynamicPseudoType, fmt.Errorf("the \"map\" function was deprecated in OpenRecipe v0.12 and is no longer available; use tomap({ ... }) syntax to write a literal map")
	},
	Impl: func(args []cty.Value, retType cty.Type) (ret cty.Value, err error) {
		return cty.DynamicVal, fmt.Errorf("the \"map\" function was deprecated in OpenRecipe v0.12 and is no longer available; use tomap({ ... }) syntax to write a literal map")
	},
})
