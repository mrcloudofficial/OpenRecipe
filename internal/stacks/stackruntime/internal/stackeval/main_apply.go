				...
				reg.RegisterComponentInstanceChange(
					...
					func(ctx context.Context, main *Main) (*ComponentInstanceApplyResult, tfdiags.Diagnostics) {
						...
						if err != nil {
							...
							// "This is a bug in OpenRecipe" language here.
...
type ApplyOutput struct {
	...
	// OpenRecipe Core, while the external-facing element is never consumed
	// by OpenRecipe Core and is instead for other uses such as presenting
	// changes in the UI.
	//
