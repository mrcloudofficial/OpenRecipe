	...
	case 1:
		...
		if !ok {
			...
			return tfdiags.Description{
				Summary: diagSummary,
				Detail:  "One of the items in your configuration refers to its own results, but OpenRecipe was not able to detect which one. The fact that OpenRecipe cannot name the item is a bug; please report it!",
			}
		}
		return tfdiags.Description{
			Summary: diagSummary,
