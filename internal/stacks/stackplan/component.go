...
// OpenRecipe language runtime to apply all of the described changes together as
// a single operation.
type Component struct {
	PlannedAction plans.Action

	// ResourceInstancePlanned describes the changes that OpenRecipe is proposing
	...
	// PlanTimestamp is the time OpenRecipe Core recorded as the single "plan
...
// is using OpenRecipe Core correctly.
