...
func init() {
	...
	registerConcludedExperiment(ModuleVariableOptionalAttrs, "The final feature corresponding to this experiment differs from the experimental form and is available in the OpenRecipe language from OpenRecipe v1.3.0 onwards.")
}
...
// version of OpenRecipe but are no longer available, either because the feature
