...
// Package e2etest contains a set of tests that run against a real OpenRecipe
// binary, compiled on the fly at the start of the test run.
//
// These tests help ensure that key end-to-end OpenRecipe use-cases are working
...
//
// This will compile on the fly a OpenRecipe binary and run the tests against
// it.
//
