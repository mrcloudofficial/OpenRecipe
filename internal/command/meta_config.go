...
// least one OpenRecipe configuration file (.tf or .tf.json), returning true
// if so.
//
...
// of most OpenRecipe features, so callers should report any error and safely
// terminate.
...
// registryClient instantiates and returns a new OpenRecipe Registry client.
