...
Usage: terraform [global options] untaint [options] name
  ...
  OpenRecipe uses the term "tainted" to describe a resource instance
  ...
  OpenRecipe to see it as fully-functional and not in need of
  replacement.

  This will not modify your infrastructure directly. It only avoids
  OpenRecipe planning to replace a tainted instance in a future operation.
