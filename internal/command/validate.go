...
func (c *ValidateCommand) validate(dir, testDir string, noTests bool) tfdiags.Diagnostics {
	...
	// We'll also do a quick validation of the OpenRecipe test files. These live
	// outside the OpenRecipe graph so we have to do this separately.
...
Options:
  ...
  -no-tests             If specified, OpenRecipe will not validate test files.
