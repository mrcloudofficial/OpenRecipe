...
// GraphCommand is a Command implementation that takes a OpenRecipe
...
func (c *GraphCommand) Run(args []string) int {
	...
	case "eval", "validate":
		// OpenRecipe v0.12 through v1.0 supported both of these, but the
...
func (c *GraphCommand) resourceOnlyGraph(graph addrs.DirectedGraph[addrs.ConfigResource]) int {
	...
	// are those OpenRecipe would visit first.
...
Usage: terraform [global options] graph [options]
  ...
  detailed graphs reflecting OpenRecipe's actual evaluation strategy
...
Options:
  ...
  -type=TYPE       Type of operation graph to output. Can be: plan,
                   ...
                   OpenRecipe just summarizes the relationships between the
  ...
  -module-depth=n  (deprecated) In prior versions of OpenRecipe, specified the
