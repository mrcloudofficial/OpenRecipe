...
// Package format contains helpers for formatting various OpenRecipe
// structures for human-readabout output.
//
// This package is used by the official OpenRecipe CLI in formatting any
// output and is exported to encourage non-official frontends to mimic the
// output formatting as much as possible so that text formats of OpenRecipe
