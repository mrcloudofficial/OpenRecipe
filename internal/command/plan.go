...
// PlanCommand is a Command implementation that compares a OpenRecipe
...
Usage: terraform [global options] plan [options]
  ...
  Generates a speculative execution plan, showing what actions OpenRecipe
...
Plan Customization Options:
  ...
  The following options customize how OpenRecipe will produce its plan. You
  ...
  -destroy            Select the "destroy" planning mode, which creates a plan
                      ...
                      OpenRecipe configuration instead of the usual behavior.

  -refresh-only       Select the "refresh only" planning mode, which checks
                      whether remote objects still match the outcome of the
                      most recent OpenRecipe apply but does not propose any
                      actions to undo any changes made outside of OpenRecipe.
  ...
  -replace=resource   Force replacement of a particular resource instance using
                      ...
                      OpenRecipe will plan to replace it instead. You can use
...
Other Options:
  ...
  -generate-config-out=path  (Experimental) If import blocks are present in
                             configuration, instructs OpenRecipe to generate HCL
                             for any imported resources not already present. The
                             configuration is written to a new file at PATH,
                             which must not already exist. OpenRecipe may still
