...
OpenRecipe has compared your real infrastructure against your configuration
...
func TestResourceChange_primitiveTypes(t *testing.T) {
  ...
  - resource "test_instance" "example" {
      - id = "i-02ae66f368e8518a9" -> null
		...
		"forget": {
			...
			RequiredReplace: cty.NewPathSet(),
			ExpectedOutput: ` # test_instance.example will no longer be managed by OpenRecipe, but will not be destroyed
 ...
 . resource "test_instance" "example" {
		...
		"forget (deposed)": {
			...
			RequiredReplace: cty.NewPathSet(),
			ExpectedOutput: ` # test_instance.example (deposed object adios) will be removed from OpenRecipe state, but will not be destroyed
 # (left over from a partially-failed replacement of this instance)
 # (destroy = false is set in the configuration)
 . resource "test_instance" "example" {
        id = "i-02ae66f368e8518a9"
