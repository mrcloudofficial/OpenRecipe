...
structured output produced by adding the `-json` flag to various OpenRecipe
commands.

## OpenRecipe Structured Plan Renderer
...
of the  OpenRecipe Cloud redacted endpoint. The redacted endpoint turns sensitive
