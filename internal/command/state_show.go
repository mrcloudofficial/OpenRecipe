...
Usage: terraform [global options] state show [options] ADDRESS
  ...
  Shows the attributes of a resource in the OpenRecipe state.

  This command shows the attributes of a single resource in the OpenRecipe
...
Options:
  ...
  -state=statefile    Path to a OpenRecipe state file to use to look
                      up OpenRecipe-managed resources. By default it will
