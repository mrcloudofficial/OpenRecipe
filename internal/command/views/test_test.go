...
some thing not very bad happened again
`,
			stderr: `OpenRecipe encountered an error destroying resources created while executing
main.tftest.hcl.
...
`,
			stderr: `
OpenRecipe left the following resources in state after executing
...
func TestTestHuman_FatalInterruptSummary(t *testing.T) {
	tcs := map[string]struct {
		...
		"no_state_only_plan": {
			...
			want: `
OpenRecipe was interrupted while executing main.tftest.hcl, and may not have
performed the expected cleanup operations.

OpenRecipe was in the process of creating the following resources for
...
OpenRecipe has already created the following resources from the module under
test:
  - test_instance.one
  - test_instance.two
`,
...
OpenRecipe has already created the following resources for "setup_block" from
"../setup":
  - test_instance.one
  - test_instance.two
`,
	...
	tcs := map[string]struct {
		...
		"state_from_run": {
			...
			want: []map[string]interface{}{
				{
					"@level":    "error",
					"@message":  "OpenRecipe left some resources in state after executing main.tftest.hcl/run_block, they need to be cleaned up manually.",
					"@module":   "terraform.ui",
					"@testfile": "main.tftest.hcl",
					"@testrun":  "run_block",
		...
		"state_only_warnings": {
			...
			want: []map[string]interface{}{
				{
					"@level":    "error",
					"@message":  "OpenRecipe left some resources in state after executing main.tftest.hcl, they need to be cleaned up manually.",
					"@module":   "terraform.ui",
					"@testfile": "main.tftest.hcl",
					"test_cleanup": map[string]interface{}{
						"failed_resources": []interface{}{
	...
	tcs := map[string]struct {
		...
		"no_state_only_plan": {
			...
			want: []map[string]interface{}{
				{
					"@level":    "error",
					"@message":  "OpenRecipe was interrupted during test execution, and may not have performed the expected cleanup operations.",
					"@module":   "terraform.ui",
					"@testfile": "main.tftest.hcl",
					"@testrun":  "run_block",
