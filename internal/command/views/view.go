...
type View struct {
	...
	// When this is true it's a hint that OpenRecipe is being run indirectly
...
// suggest specific OpenRecipe commands to run, to make more conceptual gestures
// instead for situations where the user isn't running OpenRecipe directly.
//
