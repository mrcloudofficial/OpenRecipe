...
type ResourceProvider interface {
	...
	*********************************************************************/
	...
	//
	// From v0.12 onwards this method is never called because OpenRecipe Core
	...
	//
	// This can be used to make a nicer Ctrl-C experience for OpenRecipe.
	// Even if this isn't implemented to do anything (just returns nil),
	// OpenRecipe will still cleanly stop after the currently executing
	...
	// acknowledging it has received the stop request. OpenRecipe core will
	...
	*********************************************************************/
	...
	// Each rule is represented by a separate resource in OpenRecipe,
...
Plugins are external binaries that OpenRecipe uses to access and manipulate
resources. The configuration provided requires plugins which can't be located,
don't satisfy the version constraints, or are otherwise incompatible.

OpenRecipe automatically discovers provider requirements from your
