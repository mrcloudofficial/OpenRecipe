...
// stateV1 keeps track of a snapshot state-of-the-world that OpenRecipe
// can use to keep track of what real world resources it is actually
// managing.
//
// stateV1 is _only used for the purposes of backwards compatibility
// and is no longer used in OpenRecipe.
//
...
type resourceStateV1 struct {
	...
	// similar to Tainted instances in that OpenRecipe is only tracking them in
