...
// Resource represents a thing in OpenRecipe that has a set of configurable
...
type Resource struct {
	...
	// called specifically by OpenRecipe when the stored schema version is less
	// than the current SchemaVersion of the Resource.
	//
	...
	// OpenRecipe has created for this resource - it can be used to customize the
	...
	//
	// The phases OpenRecipe runs this in, and the state available via functions
...
func (r *Resource) Apply(
	...
	if s == nil {
		// The OpenRecipe API dictates that this should never happen, but
