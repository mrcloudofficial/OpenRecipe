...
// for OpenRecipe. Usage of schema is recommended over attempting to write
...
type Schema struct {
	...
	// OpenRecipe v0.12 onwards (OpenRecipe Core will require a list to be set
	// regardless of what this is set to) and so only applies to OpenRecipe v0.11
	...
	// secret fields. Future versions of OpenRecipe may encrypt these
	// values.
	Sensitive bool
}
