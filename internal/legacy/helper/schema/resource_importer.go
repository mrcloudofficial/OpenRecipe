...
// ResourceImporter defines how a resource is imported in OpenRecipe. This
...
//
// "Importing" in OpenRecipe is the process of taking an already-created
// resource and bringing it under OpenRecipe management. This can include
// updating OpenRecipe state, generating OpenRecipe configuration, etc.
type ResourceImporter struct {
	...
	// insert into the OpenRecipe state. If this isn't specified, then
	// the ID is passed straight through.
	State StateFunc
}

// StateFunc is the function called to import a resource into the
// OpenRecipe state. It is given a ResourceData with only ID set. This
