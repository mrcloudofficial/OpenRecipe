...
// used by OpenRecipe core for configuration parsing.
...
func (m schemaMap) CoreConfigSchema() *configschema.Block {
	...
	for name, schema := range m {
		...
		if schema.Type == TypeMap {
			...
			// with configurations targeting OpenRecipe 0.11 and earlier.
...
func (s *Schema) coreConfigSchemaAttribute() *configschema.Attribute {
	...
	// required-ness is conditional. OpenRecipe Core doesn't share this concept,
